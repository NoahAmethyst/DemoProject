package com.boot_demo.demo1.service.audit.httpconnection;
...
import com.boot_demo.demo1.service.audit.model.SpeechStream;
...
public class HttpConnectionUtil {
    ...
    public static ClassificationResult uploadImage(String actionUrl, String secretId, String timestamp, String nonce,
                                                   String signature, List<String> fileLists, Options options) throws Exception {
    ...
    public static ClassificationResult uploadUri(String actionUrl, String timestamp, String nonce, String signature,
                                                 List<String> fileLists, Options options) throws Exception {
